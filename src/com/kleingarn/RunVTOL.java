...
//                    if (lightStatus) {
//                        // find squadron
//                        for (SpaceCenter.Vessel v : vtolShipAndEngines.getSquadronVessels()) {
//
//                            if(!v.equals(vtolShipAndEngines.getSquadLeader())) {
//                                logger.info("Lights are {}, going vertical", lightStatus);
//                                logger.info("Setting {} SAS and SASMode", v.getName());
//                                DockingUtils.setControlFromProbe(v, "probeCoreOcto2");
...
//                    }
                    ...
                    vtolShipAndEngines.getSquadronVessels().parallelStream().
                            filter(v -> !v.equals(vtolShipAndEngines.getSquadLeader())).
                            forEach
                                (v -> {
                                    try {
                                        logger.info("Setting {} SAS and SASMode", v.getName());
