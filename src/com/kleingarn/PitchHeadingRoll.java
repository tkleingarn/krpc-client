...
public class PitchHeadingRoll {
    ...
    public static Triplet<Float, Float, Float>  getPitchHeadingRoll(SpaceCenter spaceCenter, SpaceCenter.Vessel vessel)
        ...
        System.out.printf("pitch = %.1f, heading = %.1f, roll = %.1f\n",
                pitch, heading, roll);
        return new Triplet<Float, Float, Float>((float) pitch,(float) heading,(float) roll);
    }
